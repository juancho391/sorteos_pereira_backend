...
class User_model:
    ...
    def obtener_user(self, user_admin: User_schema.Users):
        query = select(User_schema.Users).where(User_schema.Users.email == user_admin.email)
    ...
    def validar_contraseña(self, user_admin: User_schema.UserAdminLogin, user_posible: User_schema.Users):
